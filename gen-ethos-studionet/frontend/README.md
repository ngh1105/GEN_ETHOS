...
NEXT_PUBLIC_CONTRACT_ADDRESS=0xYOUR_STUDIO_DEPLOYED_CONTRACT_ADDRESS
```
...
- This Studio backup needs a contract deployed on Studio Network. A Bradbury contract address will not work here.
